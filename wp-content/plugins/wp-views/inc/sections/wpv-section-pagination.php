								...
								<ul>
									...
									<li>
										...
										<p id="wpv-archive-spinner-uploaded" class="wpv-spinner-selection wpv-setting-extra js-wpv-archive-pagination-spinner-uploaded<?php if ( $spinner != 'uploaded' ) { echo ' hidden'; } ?>">
											<input id="wpv-archive-pagination-uploaded-spinner-image" class="js-wpv-archive-pagination-uploaded-spinner-image" type="text" value="<?php echo esc_url( $spinner_image_uploaded ); ?>" autocomplete="off" />
											...
											<img id="wpv-pagination-spinner-image-preview" class="js-wpv-archive-pagination-spinner-image-preview" src="<?php echo esc_url( $spinner_image_uploaded ); ?>" height="16"<?php if ( empty( $spinner_image_uploaded ) ) { echo ' style="display:none;"'; } ?> />
										</p>
									</li>
									<li>
									<?php $checked = ( isset( $view_settings['pagination']['spinner'] ) &&  $view_settings['pagination']['spinner'] == 'no' ) ? ' checked="checked"' : '';?>
